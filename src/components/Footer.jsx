        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/primeempire2020?igsh=eDg5dHZlcXRiamZ3"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-secondary-brown rounded-full flex items-center justify-center hover:bg-accent-saffron transition-colors"
